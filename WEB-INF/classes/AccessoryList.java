...
public class AccessoryList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String LaptopName = request.getParameter("Laptop");
		...
		pw.print("<a style='font-size: 24px;'>"+ laptop.getName() +": Accessories</a>");
	    ...
	    Accessory accessory= SaxParserDataStore.accessories.get(acc.getValue());
			...
			pw.print("<li><form method='post' action='Cart'>" +
					...
					"<input type='hidden' name='access' value='"+LaptopName+"'>"+
