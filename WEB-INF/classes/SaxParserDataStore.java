...
public class SaxParserDataStore extends DefaultHandler {
	...
	public SaxParserDataStore(String categoryXmlFileName) {
    this.categoryXmlFileName = categoryXmlFileName;
   ...
   //parse the xml using sax parser to get the data
    private void parseDocument() 
	{
	    ...
	    parser.parse(categoryXmlFileName, this);
...
////////////////////////////////////////////////////////////
    ...
    public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
        ...
        if (elementName.equals("accessory") &&  !currentElement.equals("smartphone"))
		{
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equals("accessory") && currentElement.equals("smartphone")) 
		{
			accessoryHashMap.put(elementValueRead,elementValueRead);
		}
      	if (element.equalsIgnoreCase("accessories") && currentElement.equals("smartphone")) {
